...
export const selfAttendanceContentMap: Record<Language, SelfAttendanceContent> = {
  en: {
    ...
    pageSubtitle: "Submit attendance by email OTP or rotating code. All requests are pending approval.",    
    ...
    otpTitle: "Attendance Submission",    
    otpSubtitle:
      "Use either a 6-digit email OTP (with GPS verification) or the rotating attendance code from HR/Manager. Every submission remains pending until approved.",      
  ...
  ar: {
    ...
    pageTitle: "حضوري",
    pageSubtitle: "سجّل حضورك عبر OTP البريد أو كود الحضور المتغير. كل الطلبات تنتظر الموافقة.",    
    userFallback: "ضيف",
    todayLabel: "اليوم",
    statusLabel: "الحالة",
    statusMap: {
    ...
    otpTitle: "إرسال الحضور",    
    otpSubtitle:
      "يمكنك استخدام OTP البريد (مع التحقق بالموقع) أو كود الحضور المتغير من HR/Manager. جميع الطلبات تبقى معلقة حتى اعتمادها.",      
